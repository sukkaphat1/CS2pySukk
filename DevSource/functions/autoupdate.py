...
def get_remote_version():
    ...
    try:
        url = "https://raw.githubusercontent.com/sukkaphat1/CS2pySukk/refs/heads/main/version.txt"
...
def get_remote_file_list():
    ...
    try:
        api_url = "https://api.github.com/repos/sukkaphat1/CS2pySukk/git/trees/main?recursive=1"
        ...
        for item in data.get('tree', []):
            if item['type'] == 'blob':
                files.append({
                    'path': item['path'],
                    'url': f"https://raw.githubusercontent.com/sukkaphat1/CS2pySukk/refs/heads/main/{item['path']}"
                })
